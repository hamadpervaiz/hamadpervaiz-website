...
export const memos: Memo[] = [
  {
    ...
    time: "13 MIN READ",
    sections: [
      { type: "heading", content: "// 01. THE OLD TOOLS MADE EVERYTHING WORSE AND NOBODY ADMITTED IT" },
      {
        type: "paragraph",
        content:
          "For two years, the software industry ran a $7 billion experiment on itself. Forty-one percent of all code written in 2025 was generated by AI. Microsoft announced 30%. Google said 25%. Ninety percent of Fortune 100 companies deployed GitHub Copilot. Twenty million developers signed up. The industry declared victory before checking the scoreboard.",
      },
      {
        type: "paragraph",
        content:
          "Then the scoreboard came in. Google\u2019s own DORA report \u2014 the most rigorous annual study of software delivery performance on the planet \u2014 found that despite 90% AI adoption among developers, organizational delivery metrics stayed completely flat. Not improved. Flat. Individual output was up: 21% more tasks completed, 98% more pull requests merged. But the software reaching production was no better, no faster, and no more reliable than before the entire industry adopted AI tooling. Pull request sizes inflated 154%. Code review time grew 91%. Bug rates increased 9% with higher AI adoption. Security vulnerabilities were 2.74 times higher in AI-generated code. The industry was not getting faster. It was generating more surface area for failure while congratulating itself on throughput metrics.",
      },
      {
        type: "paragraph",
        content:
          "The METR study made it worse. A randomized controlled trial with experienced open-source developers across 246 real tasks. The developers predicted AI tools would make them 24% faster. After using the tools, they believed they were 20% faster. Actual measurement: 19% slower. A 39-point gap between perception and reality. Three out of four participants saw reduced performance. This was not a tech company selling product. This was a peer-reviewed experiment. Its conclusion was devastating: the Copilot-era tools made experienced developers objectively worse at their jobs while convincing them they were better. The industry spent two years and billions of dollars on a placebo with a subscription fee.",
      },
      {
        type: "blockquote",
        content:
          "The software industry confused typing speed with engineering capability. For two years it celebrated tools that inflated output, degraded quality, and made developers measurably slower \u2014 while those developers believed they were faster. That is not adoption. That is a collective hallucination.",
      },
      { type: "heading", content: "// 02. THEN FEBRUARY FIFTH HAPPENED" },
      {
        type: "paragraph",
        content:
          "On February 3, 2026, Anthropic launched Cowork. Two days later, $285 billion was wiped from SaaS stocks in a single trading session. Thomson Reuters dropped 18% \u2014 its worst day on record. LegalZoom fell 20%. Salesforce dropped 7%. The S\u0026P 500 Software \u0026 Services Index collapsed 20% year to date. The market processed in forty-eight hours what most engineers have still not absorbed: the tools that arrived in February 2026 are not incremental improvements on the tools that made developers 19% slower. They are a different category of system entirely.",
      },
      {
        type: "paragraph",
        content:
          "Claude Opus 4.6 shipped with a one-million-token context window. That is not a larger input field. That is an entire large codebase fitting into a single reasoning session \u2014 every dependency, every edge case, every architectural decision buried in a file nobody has touched in two years. The model sees the whole system at once. Combined with Agent Teams \u2014 multiple autonomous Claude instances that coordinate, negotiate conflicts, share type definitions, and converge on solutions without human intervention \u2014 you are no longer looking at a tool that helps a developer write code. You are looking at a system that replaces the execution layer of software engineering entirely.",
      },
      {
        type: "callout",
        content:
          "Anthropic stress-tested Agent Teams with sixteen agents building a C compiler from scratch. Rakuten ran Opus 4.6 against a 12.5-million-line codebase and achieved 99.9% accuracy in seven autonomous hours. Claude Code now authors 4% of all public GitHub commits, with projections of 20% or more by year end. Its run-rate revenue doubled to $2.5 billion in two months. Business subscriptions quadrupled since January. This is not incremental adoption. This is a phase transition measured in billions of dollars and hundreds of billions in destroyed market capitalization.",
      },
      {
        type: "paragraph",
        content:
          "The METR study that showed developers were 19% slower tested Claude 3.5 Sonnet with 200,000 tokens of context on codebases the developers already knew intimately. METR\u2019s own researchers acknowledged their design \u201Cmay understate AI\u2019s potential impact\u201D and that the real leverage comes from \u201Ccommanding an army of agents in parallel\u201D \u2014 precisely the capability that did not exist when they ran the study. The old tools were autocomplete with a conversation wrapper. The new tools are autonomous systems with a million tokens of memory and the ability to coordinate with each other. The people citing the METR study to dismiss AI coding in March 2026 are using bicycle data to evaluate jet engines.",
      },
      { type: "heading", content: "// 03. THE TYPIST IS DEAD. THE ARCHITECT JUST GOT PROMOTED." },
      {
        type: "paragraph",
        content:
          "Stanford researchers analyzed payroll records for millions of workers and found that employment for software developers aged 22 to 25 has declined nearly 20% since late 2022. Junior developer hiring at Big Tech collapsed from 32% of new hires in 2019 to 7% in 2026. Internship postings dropped 30%. Entry-level tech unemployment sits at 7.4% \u2014 nearly double the national average. The pipeline is being destroyed and the industry is in grief.",
      },
      {
        type: "paragraph",
        content:
          "But employment for developers over 30 grew 6 to 12% in the same period. The two cohorts moved in lockstep for years and then diverged sharply at the exact moment AI tools arrived. That divergence is diagnostic. AI did not eliminate engineering. It eliminated transcription. The juniors who were hired to convert specifications into syntax \u2014 those roles are gone. The seniors who architect systems, define constraints, make judgment calls under ambiguity, and own consequences are more employed than ever.",
      },
      {
        type: "paragraph",
        content:
          "Here is the uncomfortable truth the industry will not say plainly, so I will: most of what passed for software engineering was never engineering. It was transcription. Taking a Jira ticket and turning it into a pull request. Taking someone else\u2019s architecture and implementing it keystroke by keystroke. AI did not disrupt that job. AI revealed it was never a defensible job in the first place. And Opus 4.6 did not just expose the gap \u2014 it made the gap structural. An architect who can now spin up sixteen parallel agent instances, each with a million tokens of context, operating autonomously for hours \u2014 that person\u2019s output did not increase linearly. It increased by an order of magnitude. The typist\u2019s output went to zero. That divergence is permanent.",
      },
      {
        type: "blockquote",
        content:
          "A senior Google engineer told a reporter: \u2018I\u2019m basically a proxy to Claude Code. My manager tells me what to do, and I tell Claude to do it.\u2019 His predominant feeling: grief. He is not describing the death of engineering. He is describing the death of transcription. And if a senior engineer at Google cannot tell the difference, the industry has a much bigger problem than AI displacement.",
      },
      { type: "heading", content: "// 04. THE VERDICT" },
      {
        type: "paragraph",
        content:
          "I run 65 engineers at BearPlex. Not one of them was ever hired to type code. Every single one was hired to architect systems \u2014 to decompose ambiguous problems, to define the rules and constraints and failure modes of systems that run without human intervention, to make the decisions that machines cannot make. The Copilot era did not help us. We watched the industry inflate its pull request sizes by 154% and call it productivity. We watched developers become 19% slower while believing they were 20% faster. We did not participate in that delusion.",
      },
      {
        type: "paragraph",
        content:
          "Opus 4.6 is different. When you hand an engineer who thinks architecturally a fleet of autonomous agents with a million tokens of context, agents that coordinate with each other, debug their own failures, and deliver working systems after hours of unsupervised execution \u2014 the leverage is not incremental. It is structural. The output is not more code. It is better systems, delivered faster, with fewer humans in the execution loop. That is what the Architect Economy was always about. But that leverage only works if the human was doing architecture in the first place. If they were doing transcription, the agent does not assist them. It replaces them. There is no middle ground. February 5th made that binary visible to the entire market in a single trading session.",
      },
      {
        type: "paragraph",
        content:
          "The industry is trapped in a dual delusion. The first delusion: that the old tools worked. They did not. Every rigorous study says so. The second delusion: that the new tools are just better versions of the old ones. They are not. Opus 4.6 with Agent Teams is to GitHub Copilot what a self-driving factory is to a power drill. Same industry. Different civilization. The companies still debating whether AI coding tools improve productivity are asking a question the market already answered \u2014 with $285 billion in evaporated value and a capability gap that widens every month.",
      },
      {
        type: "paragraph",
        content:
          "The question is not \u201Cwill AI replace software engineers?\u201D The question is: did you ever have software engineers, or did you have typists with engineering titles? Because the data is unambiguous. The old tools made typists slower. The new tools made architects unstoppable. And the gap between those two realities is the defining fault line of this industry for the next decade. Hype is a temporary tactic. Architecture is a permanent advantage. And AI just made that advantage impossible to ignore.",
      },
    ],
  },
  {
