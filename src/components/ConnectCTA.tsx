...
export default function ConnectCTA() {
  return (
    <section className="w-full bg-[var(--bg-primary)] border-t border-[var(--border-faint)] py-24 sm:py-32 lg:py-40 px-6 md:px-16 lg:px-[120px]">
      <motion.div
      ...
      >
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.98 }}
          className="flex items-center gap-3 font-inter text-[11px] sm:text-xs font-medium tracking-[2.5px] text-[var(--text-on-accent)] bg-[var(--accent)] px-10 sm:px-14 py-5 sm:py-6 rounded-full shadow-[0_0_20px_var(--shadow-accent-sm)] hover:shadow-[0_0_40px_var(--shadow-accent-lg)] transition-shadow mt-4"
        >
          LET&apos;S CONNECT
